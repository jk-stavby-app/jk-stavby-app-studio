        ...
        <div className="bg-[#FAFBFC] rounded-[32px] border border-[#E2E5E9] p-8 md:p-12 transition-all">
          ...
          {!isSubmitted ? (
            ...
            <div className="text-center py-4">
              ...
              <Link
                to="/login"
                className="inline-block w-full px-6 py-3 min-h-[48px] bg-[#5B9AAD] text-[#F8FAFC] rounded-xl font-medium text-base hover:bg-[#4A8A9D] transition-colors text-center leading-relaxed flex items-center justify-center"
              >
                Zpět na přihlášení
              </Link>
            </div>
