...
const Toast: React.FC<ToastProps> = ({ message, type, onClose }) => {
  ...
  return (
    <div className={`fixed bottom-8 right-8 z-[100] flex items-center gap-3 px-5 py-4 rounded-2xl border ${backgrounds[type]} animate-in slide-in-from-bottom-4 fade-in duration-300`}>
